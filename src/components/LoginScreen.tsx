      ...
      <div className="max-w-[360px] mx-auto w-full flex-1 flex flex-col">
        ...
        <div className="px-6 pb-10 space-y-3">
          ...
          <button
            ...
            className="w-full py-4 bg-[#FEE500] rounded-full font-medium text-sm text-[#000000] shadow-sm hover:shadow-md transition-all active:scale-98 flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="w-full py-4 bg-white rounded-full font-medium text-sm text-[#1d1b20] shadow-sm hover:shadow-md transition-all active:scale-98 flex items-center justify-center gap-2 border border-[#e7e0ec]"
          >
          ...
          <button
            ...
            className="w-full py-4 bg-[#000000] rounded-full font-medium text-sm text-white shadow-sm hover:shadow-md transition-all active:scale-98 flex items-center justify-center gap-2"
          >
